<?php
    ...
    class User extends Database{
        ...
        * into the database table (users table)
        */
        ...
        public function login($request){
            ...
            $password = $request['password']; //password received coming from the form
            ...
            if ($result->num_rows == 1) { //if this is TRUE that num_rows == 1, then meaning the username exists
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    header('location: ../views/dashboard.php'); //redirect the user to dashboard
                    exit;
                }else {
